...
const auditLogs: AuditData[] = [
  ...
  },
  {
    ...
    action: "UPDATE",
    entityType: "Case",
    details: "TRO issued by RTC Branch 45 — Santos Foreclosure Defense granted 72-hour TRO",
    daysAgo: 2,
  },
  {
    actorEmail: "david.tan@aninolaw.com",
    action: "CREATE",
    entityType: "Payment",
    details: "Milestone payment recorded: Title Verification for Dela Cruz case — PHP 25,000",
    daysAgo: 7,
  },
  {
    actorEmail: "catherine.diaz@aninolaw.com",
    action: "CREATE",
    entityType: "Payment",
    details: "Retainer payment recorded: Fernandez criminal defense balance — PHP 30,000",
    daysAgo: 10,
  },
  {
    actorEmail: "sofia.villanueva@aninolaw.com",
    action: "CREATE",
    entityType: "Document",
    details: "Uploaded: Provisional-Order-Gonzales.pdf",
    daysAgo: 5,
  },
  {
    actorEmail: "gina.reyes@aninolaw.com",
    action: "CREATE",
    entityType: "Document",
    details: "Uploaded: LBAA-Appeal-Hearing-Notice.pdf",
    daysAgo: 4,
  },
  {
    actorEmail: "angela.mercado@aninolaw.com",
    action: "CREATE",
    entityType: "Milestone",
    details: "Milestone created: Due Diligence Completed for Ramirez Corp Series A",
    daysAgo: 1,
  },
  {
    actorEmail: "marco.lopez@aninolaw.com",
    action: "UPDATE",
    entityType: "Task",
    details: "Task status changed: Negotiate Loan Restructuring with Bank set to Ongoing",
    daysAgo: 0,
  },
  {
    actorEmail: "catherine.diaz@aninolaw.com",
    action: "UPDATE",
    entityType: "Payment",
    details: "Payment status updated to Paid: Fernandez criminal defense retainer balance",
    daysAgo: 5,
  },
  {
    actorEmail: "david.tan@aninolaw.com",
    action: "UPDATE",
    entityType: "Milestone",
    details: "Milestone completed: Title Verification Complete for Dela Cruz case",
    daysAgo: 3,
  },
  {
    actorEmail: "sofia.villanueva@aninolaw.com",
